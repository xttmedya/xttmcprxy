...
$msg[] = "$output . Yayin 10 Kapat...";
 ...
 if($_POST['doSave'] == 'Kapat Yayin 11')
{
foreach($_POST as $key => $value) {
        $data[$key] = filter($value);
}

$output = shell_exec("sudo -u iptv /home/iptv/ligtv/stop_stream stream11");

//header("Location: stream.php?msg=Yayin 11 Kapat ... ");
$msg[] = "$output . Yayin 11 Kapat...";
 }
 
 
 if($_POST['doSave'] == 'Kapat Yayin 12')
{
foreach($_POST as $key => $value) {
        $data[$key] = filter($value);
}

$output = shell_exec("sudo -u iptv /home/iptv/ligtv/stop_stream stream12");

//header("Location: stream.php?msg=Yayin 12 Kapat ... ");
$msg[] = "$output . Yayin 12 Kapat...";
 }
 
 
 if($_POST['doSave'] == 'Kapat Yayin 13')
{
foreach($_POST as $key => $value) {
        $data[$key] = filter($value);
}

$output = shell_exec("sudo -u iptv /home/iptv/ligtv/stop_stream stream13");

//header("Location: stream.php?msg=Yayin 13 Kapat ... ");
$msg[] = "$output . Yayin 13 Kapat...";
 }
 
 
 if($_POST['doSave'] == 'Kapat Yayin 14')
{
foreach($_POST as $key => $value) {
        $data[$key] = filter($value);
}

$output = shell_exec("sudo -u iptv /home/iptv/ligtv/stop_stream stream14");

//header("Location: stream.php?msg=Yayin 14 Kapat ... ");
$msg[] = "$output . Yayin 14 Kapat...";
 }
 
 
 if($_POST['doSave'] == 'Kapat Yayin 15')
{
foreach($_POST as $key => $value) {
        $data[$key] = filter($value);
}

$output = shell_exec("sudo -u iptv /home/iptv/ligtv/stop_stream stream15");

//header("Location: stream.php?msg=Yayin 15 Kapat ... ");
$msg[] = "$output . Yayin 15 Kapat...";
 }
 
 
 
if($_POST['doSave'] == 'RESTART STREAM PORTLARI')
{
foreach($_POST as $key => $value) {
        $data[$key] = filter($value);
}

$output = shell_exec("sudo -u iptv /home/iptv/ligtv/restart_stream stream");

//header("Location: stream.php?msg=RESTART STREAM PORTLARI ... ");
$msg[] = "$output . RESTART STREAM PORTLARI...";
 }
...
<h3 class="titlehdr">Yayin Ayarlari ...</h3>
       ...
       <form action="stream.php" method="post" name="myform" id="myform">
        <table width="70%" border="0" align="left" cellpadding="3" cellspacing="3" class="forms">
          <tr>
            <td colspan="2"><strong>PORTLARI RESTART ET</strong><br>
              

        </table>
        <p align="center">
          <input name="doSave" type="submit" id="doSave" value="RESTART STREAM PORTLARI">
      </form>
...
<?php while ($row_settings = mysql_fetch_array($rs_settings10)) {?>
      <form action="stream.php" method="post" name="myform" id="myform">
        <table width="70%" border="0" align="left" cellpadding="3" cellspacing="3" class="forms">
          <tr>
            <td colspan="2"><strong>YAYIN 10 -  PORT 5010 </strong><br> <input name="yayin10" type="text" id="yayin10"  class="required" value="<?php echo $row_settings['stream_server']; ?>" size="75">
          </tr>
<?php } ?>
...
<?php while ($row_settings = mysql_fetch_array($rs_settings11)) {?>
      <form action="stream.php" method="post" name="myform" id="myform">
        <table width="70%" border="0" align="left" cellpadding="3" cellspacing="3" class="forms">
          <tr>
            <td colspan="2"><strong>YAYIN 11 -  PORT 5011 </strong><br> <input name="yayin11" type="text" id="yayin11"  class="required" value="<?php echo $row_settings['stream_server']; ?>" size="75">
          </tr>
<?php } ?>
        ...
        <p align="center">           
          ...
          <input name="doSave" type="submit" id="doSave" value="Restart Yayin 11">
		   <input name="doSave" type="submit" id="doSave" value="Kapat Yayin 11">
...
<?php while ($row_settings = mysql_fetch_array($rs_settings12)) {?>
      <form action="stream.php" method="post" name="myform" id="myform">
        <table width="70%" border="0" align="left" cellpadding="3" cellspacing="3" class="forms">
          <tr>
            <td colspan="2"><strong>YAYIN 12 -  PORT 5012 </strong><br> <input name="yayin12" type="text" id="yayin12"  class="required" value="<?php echo $row_settings['stream_server']; ?>" size="75">
          </tr>
<?php } ?>
        ...
        <p align="center">           
          ...
          <input name="doSave" type="submit" id="doSave" value="Restart Yayin 12">
		   <input name="doSave" type="submit" id="doSave" value="Kapat Yayin 12">
...
<?php while ($row_settings = mysql_fetch_array($rs_settings13)) {?>
      <form action="stream.php" method="post" name="myform" id="myform">
        <table width="70%" border="0" align="left" cellpadding="3" cellspacing="3" class="forms">
          <tr>
            <td colspan="2"><strong>YAYIN 13 -  PORT 5013 </strong><br> <input name="yayin13" type="text" id="yayin13"  class="required" value="<?php echo $row_settings['stream_server']; ?>" size="75">
          </tr>
<?php } ?>
        ...
        <p align="center">           
          ...
          <input name="doSave" type="submit" id="doSave" value="Restart Yayin 13">
		   <input name="doSave" type="submit" id="doSave" value="Kapat Yayin 13">
...
<?php while ($row_settings = mysql_fetch_array($rs_settings14)) {?>
      <form action="stream.php" method="post" name="myform" id="myform">
        <table width="70%" border="0" align="left" cellpadding="3" cellspacing="3" class="forms">
          <tr>
            <td colspan="2"><strong>YAYIN 14 -  PORT 5014 </strong><br> <input name="yayin14" type="text" id="yayin14"  class="required" value="<?php echo $row_settings['stream_server']; ?>" size="75">
          </tr>
<?php } ?>
        ...
        <p align="center">           
          ...
          <input name="doSave" type="submit" id="doSave" value="Restart Yayin 14">
		   <input name="doSave" type="submit" id="doSave" value="Kapat Yayin 14">
...
<?php while ($row_settings = mysql_fetch_array($rs_settings15)) {?>
      <form action="stream.php" method="post" name="myform" id="myform">
        <table width="70%" border="0" align="left" cellpadding="3" cellspacing="3" class="forms">
          <tr>
            <td colspan="2"><strong>YAYIN 15 -  PORT 5015 </strong><br> <input name="yayin15" type="text" id="yayin15"  class="required" value="<?php echo $row_settings['stream_server']; ?>" size="75">
          </tr>
<?php } ?>
        ...
        <p align="center">           
          ...
          <input name="doSave" type="submit" id="doSave" value="Restart Yayin 15">
		   <input name="doSave" type="submit" id="doSave" value="Kapat Yayin 15">
