...
$err[] = "HATA - Gecerli bir email adresi giriniz..."; 
}
...
$num = mysql_num_rows($rs_check);
  // Match row found with more than 1 results  - the user is authenticated. 
    if ( $num <= 0 ) { 
	$err[] = "Hata - Boyle bir kullanici kayitli degil... ";
...
$message = 
"Yeni sifre detayiniz asagidaki gibidir ...\n
Email Adresiniz : $user_email \n
Sifreniz: $new_pwd \n

Bizi tercih ettiginiz icin tesekkur ederiz.

______________________________________________________
BU OTOMATIK OLARAK GONDERILEN BIR MESAJDIR 
*** LUTFEN CEVAP YAZMAYIN ***
";
...
$msg[] = "Kullanici sifreniz resetlendi ve yeni sifreniz email adresinize gonderildi ...";						 
...
<h3 class="titlehdr">Forgot Password</h3>
	...
	if(!empty($err))  {
      ...
      <p>Eger sifrenizi unuttu iseniz  <strong>Reset</strong> butonuna basiniz. Yeni sifreniz adresinize gonderilecektir </p>
      ...
      <form action="forgot.php" method="post" name="actForm" id="actForm" >
        <table width="65%" border="0" cellpadding="4" cellspacing="4" class="loginform">
          ...
          <tr> 
            <td width="36%">Email Adresiniz</td>
